...
$('#openai-chat-window').hide(); // Hide chat window initially
    ...
    async function handleQuestion(questionElement, answerElement) {
        ...
        // $.get('https://raw.githubusercontent.com/medanticancerbelievescotland/knowledge/main/knowledge_uk.txt')     
        $.get(knowledgeURL)
            .then(function(data) {
                var knowledge = data;
                    ...
                    var api_key = 'sk-'+ 'dI9WRv1so' + 'NiXpAy0cW'+'D0T3BlbkF'+'JwXLHRC'+'Rjxg5Gl'+'bDNiGhk';
